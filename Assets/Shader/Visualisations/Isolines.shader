                ...
                for (int i = 0; i < _CenterPointAmount; i++)
                {
                    ...
                    if (_IsolinesAmount > 0) {
                        ...
                        for (float i = 1; i <= _IsolinesAmount; i++) {
                            ...
                            if (i % 1 == 0 && vertexToCenterDistance < isolinesStepSize * i + _IsolineThickness / 2 && vertexToCenterDistance > isolinesStepSize * i - _IsolineThickness/2){
                                o.Albedo = float3(0, 0, 0);
                                o.Alpha = 1;
                            }
                            //if (i % 1 == 0 && vertexToCenterDistance + _IsolineThickness < isolinesStepSize * i && vertexToCenterDistance > isolinesStepSize * i - _IsolineThickness){
                            //    o.Albedo = float3(0, 0, 0);
                            //    o.Alpha = 1;
                            //}
